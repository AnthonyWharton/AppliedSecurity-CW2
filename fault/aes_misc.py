################################################################################
# Galois Field multiplication with Rijndael's Finite Field. For algorithm
# explanation refer to:
# https://en.wikipedia.org/wiki/Finite_field_arithmetic#Rijndael's_finite_field
# Arguments:
#   a - integer: Operand for multiplication, must be no larger than 8 bits
#   b - integer: Operand for multiplication, must be no larger than 8 bits
# Return:
#   integer: The result of a * b under Rijndael's Finite Field.
def gf28_mul(a, b):
	p = 0b00000000
	a = 0b11111111 & a
	b = 0b11111111 & b
...
class AESRoundFunction:
	...
	@staticmethod
	def valid(r):
		return r in [AESRoundFunction.AddRoundKey, AESRoundFunction.SubBytes,
